...
///
/// ikfast version 0x1000004a generated on 2019-02-12 06:37:43.316377
...
x42=((((-1.0)*x17*x7))+x39);
x43=(((x0*x7))+x40);
x44=(((x13*(((((-1.0)*x31))+(((1.0)*x28))))))+(((-1.0)*x15*x34*x5)));
x45=((((-1.0)*x15*x42))+((x13*((((x19*x26))+((x19*x27)))))));
x46=((((-1.0)*x15*x43))+((x13*((((x17*x26))+((x17*x27)))))));
eerot[0]=(((x45*x8))+((x9*(((((-1.0)*x20*x37))+x30)))));
eerot[1]=(((x8*(((((-1.0)*x30))+((x37*x7))))))+((x45*x9)));
eerot[2]=(((x11*x42))+((x10*((((x0*x26))+((x0*x27)))))));
eetrans[0]=(((x22*x26))+((x22*x27))+((x0*x18))+((x10*((((x21*x26))+((x21*x27))))))+(((0.05)*x0))+((x14*x25))+(((-1.0)*x14*x28))+((x11*((((x24*x35))+(((-1.0)*x23*x7)))))));
eerot[3]=(((x9*(((((-1.0)*x20*x38))+(((-1.0)*x19*x5))))))+((x46*x8)));
eerot[4]=(((x46*x9))+((x8*((((x0*x5))+x41)))));
eerot[5]=(((x11*x43))+((x10*((((x27*x6))+((x26*x6)))))));
eetrans[1]=(((x18*x6))+((x10*((((x23*x27))+((x23*x26))))))+(((0.05)*x6))+(((-1.0)*x16*x28))+((x11*((((x21*x7))+((x24*x36))))))+((x16*x25))+((x12*x26))+((x12*x27)));
eerot[6]=(((x34*x7*x9))+((x44*x8)));
eerot[7]=(((x7*x8*(((((-1.0)*x26))+(((-1.0)*x27))))))+((x44*x9)));
eerot[8]=(((x29*x34))+((x10*(((((-1.0)*x31))+x28)))));
eetrans[2]=((0.33)+(((0.335)*x28))+(((-0.335)*x25))+(((0.33)*x1))+((x29*(((((0.08)*x27))+(((0.08)*x26))))))+(((0.035)*x27))+(((0.035)*x26))+((x10*(((((-0.08)*x25))+(((0.08)*x28)))))));
}
...
IkReal x1520=(py*sj0);
IkReal x1521=(cj0*px);
IkReal x1522=((0.335)*sj2);
IkReal x1523=(cj2*sj2);
IkReal x1524=((0.035)*cj2);
IkReal x1525=((1.0)*pz);
CheckValue<IkReal> x1526 = IKatan2WithCheck(IkReal(((-0.221125)+(((-0.02345)*x1523))+(((-0.2211)*sj2))+(pz*pz)+(((-0.0231)*cj2))+(((0.111)*x1519)))),IkReal(((0.011725)+(((-0.02345)*x1519))+(((-0.11055)*cj2))+(((-0.111)*x1523))+(((0.01155)*sj2))+(((-1.0)*x1520*x1525))+(((-1.0)*x1521*x1525))+(((0.05)*pz)))),IKFAST_ATAN2_MAGTHRESH);
if(!x1526.valid){
continue;
}
CheckValue<IkReal> x1527=IKPowWithIntegerCheck(IKsign(((0.0165)+(((-0.33)*x1521))+(((-0.33)*x1520))+(((-0.335)*cj2*pz))+(((0.00175)*cj2))+(((-1.0)*x1520*x1522))+(((-1.0)*x1520*x1524))+(((0.035)*pz*sj2))+(((0.01675)*sj2))+(((-1.0)*x1521*x1522))+(((-1.0)*x1521*x1524)))),-1);
if(!x1527.valid){
continue;
}
...
IkReal x1530=((0.035)*sj2);
IkReal x1531=((0.335)*sj2);
IkReal x1532=(py*sj0);
IkReal x1533=((0.035)*cj2);
IkReal x1534=((0.335)*cj2);
IkReal x1535=(cj0*px);
IkReal x1536=((1.0)*x1535);
IkReal x1537=((1.0)*x1528);
IkReal x1538=((0.66)*x1529);
evalcond[0]=((((0.05)*x1528))+(((-1.0)*x1530))+(((-1.0)*x1532*x1537))+x1534+(((-1.0)*x1528*x1536))+((pz*x1529)));
evalcond[1]=((((-1.0)*x1529*x1530))+(((-0.33)*x1528))+((x1529*x1534))+pz+(((-1.0)*x1528*x1533))+(((-1.0)*x1528*x1531)));
evalcond[2]=((0.33)+(((-1.0)*x1529*x1532))+(((-1.0)*x1529*x1536))+(((0.05)*x1529))+x1533+x1531+(((-1.0)*pz*x1537)));
evalcond[3]=((0.00205)+(((-0.033)*x1529))+((x1532*x1538))+(((-1.0)*pp))+(((0.1)*x1535))+(((0.1)*x1532))+((x1535*x1538))+(((0.66)*pz*x1528)));
evalcond[4]=((0.05)+(((-1.0)*x1532))+(((0.33)*x1529))+((x1528*x1534))+(((-1.0)*x1536))+((x1529*x1533))+((x1529*x1531))+(((-1.0)*x1528*x1530)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x1540=(py*sj0);
IkReal x1541=((0.035)*sj2);
IkReal x1542=(cj2*sj2);
IkReal x1543=(cj0*px);
IkReal x1544=((0.335)*cj2);
CheckValue<IkReal> x1545 = IKatan2WithCheck(IkReal(((0.011725)+(((-0.11055)*cj2))+(((-0.05)*pz))+(((-0.111)*x1542))+(((0.01155)*sj2))+((pz*x1540))+((pz*x1543))+(((-0.02345)*x1539)))),IkReal(((-0.001225)+(((-0.111)*x1539))+(((0.02345)*x1542))+(pz*pz))),IKFAST_ATAN2_MAGTHRESH);
if(!x1545.valid){
continue;
}
CheckValue<IkReal> x1546=IKPowWithIntegerCheck(IKsign(((((-1.0)*x1543*x1544))+(((-1.0)*x1540*x1544))+((x1541*x1543))+(((0.33)*pz))+(((-0.00175)*sj2))+((x1540*x1541))+(((0.035)*cj2*pz))+(((0.01675)*cj2))+(((0.335)*pz*sj2)))),-1);
if(!x1546.valid){
continue;
}
...
IkReal x1549=((0.035)*sj2);
IkReal x1550=((0.335)*sj2);
IkReal x1551=(py*sj0);
IkReal x1552=((0.035)*cj2);
IkReal x1553=((0.335)*cj2);
IkReal x1554=(cj0*px);
IkReal x1555=((1.0)*x1554);
IkReal x1556=((1.0)*x1547);
IkReal x1557=((0.66)*x1548);
evalcond[0]=((((0.05)*x1547))+x1553+(((-1.0)*x1551*x1556))+((pz*x1548))+(((-1.0)*x1547*x1555))+(((-1.0)*x1549)));
evalcond[1]=((((-1.0)*x1548*x1549))+(((-0.33)*x1547))+pz+((x1548*x1553))+(((-1.0)*x1547*x1552))+(((-1.0)*x1547*x1550)));
evalcond[2]=((0.33)+(((-1.0)*pz*x1556))+(((0.05)*x1548))+(((-1.0)*x1548*x1551))+(((-1.0)*x1548*x1555))+x1550+x1552);
evalcond[3]=((0.00205)+((x1551*x1557))+(((0.1)*x1554))+(((0.1)*x1551))+(((-0.033)*x1548))+(((-1.0)*pp))+((x1554*x1557))+(((0.66)*pz*x1547)));
evalcond[4]=((0.05)+(((-1.0)*x1551))+((x1547*x1553))+(((0.33)*x1548))+(((-1.0)*x1547*x1549))+((x1548*x1552))+((x1548*x1550))+(((-1.0)*x1555)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IKFAST_API const char* GetKinematicsHash() { return "58b9707e4b54ff3fcaefa69ab8693593"; }
