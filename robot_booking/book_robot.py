import sys
import robot_booking.FreeBusy_Classes.FreeBusy_App as fb_app
import re
import argparse
...
def get_args():
    ...
    parser.add_argument('robot name', type=str, nargs="+", help='name of robot i.e. VS, M-20, etc.')
...
if __name__ == "__main__":
    ...
    app = fb_app.FreebusyApp(robot_ids, robots, start_date, end_date)
    app.initialize()
